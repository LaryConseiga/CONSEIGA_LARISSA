...
const API_URL = API_ROOT ? `${API_ROOT}/api/civilites` : "/api/civilites";
...
// Modifier une civilité
export const updateCivilite = (id, civilite) => {
...
export const deleteCivilite = (id) => {
    return fetchWithTimeout(`${API_URL}/${id}`, {
        method: "DELETE",
    }).then(handleResponse);
};
